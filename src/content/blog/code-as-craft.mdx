...
<ArticleImage 
  ...
  alt="Code editor showing elegant Python code" 
  caption="Beautiful code has a visual rhythm that mirrors its logical flow."
/>
...
<ArticleImage 
  ...
  caption="The tools may evolve, but the craft remains timeless."
/>
